...
can be very flexible but must be used with caution.
...
Setting `options(scidb.tryeval=FALSE)` results in more straightforward but
somewhat less flexible AFL expression handling.
