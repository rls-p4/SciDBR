...
* `tsvd`  Compute a truncated singular value decomposition or optionally principal components of a sparse or dense SciDB matrix
...
Other mathematical operations are available through direct use of SciDB's
native AFL query language.
