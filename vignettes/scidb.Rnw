...
\end{Sinput}
\begin{Soutput}
SciDB array name:  R_arrayb8923e9f64411...
...
\begin{Soutput}
            [,1]       [,2]       [,3]        [,4]       [,5]
[1,]  0.99435309 -1.6141523  0.8892604 -0.04641526 -1.1639437
[2,] -1.61415233  3.4992042  1.1145039 -0.83391353 -0.2002475
[3,]  0.88926036  1.1145039 20.4775322 -5.46976848 -5.7176497
[4,] -0.04641526 -0.8339135 -5.4697685  1.67923502  2.4183109
[5,] -1.16394368 -0.2002475 -5.7176497  2.41831086  9.1087383
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] "slice(sg(subarray(between(transpose(test),3,0,3,4),3,0,3,4),1,-1), j, 0)"
\end{Soutput}
\begin{Sinput}
> B@schema
\end{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] "R_arrayb894bb3dc3d1101244561819"
\end{Soutput}
\begin{Sinput}
> C@schema
\end{Sinput}
