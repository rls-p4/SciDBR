...
SciDB schema:  <Expt:int32 NULL DEFAULT null,
                Run:int32 NULL DEFAULT null,
                Speed:int32 NULL DEFAULT null> [row=1:100,100,0]
...
\end{Sinput}
\begin{Soutput}
SciDB expression:  R_arraye557070d5021101257184071
...
\begin{Soutput}
           0          1         2          3          4
0  3.8733681 -4.1637408 -2.198350 -1.6384182 -0.4042902
1 -4.1637408  7.8201237  2.157000  0.6690904 -0.1844615
2 -2.1983502  2.1570000  2.688858  2.1093709  0.7793700
3 -1.6384182  0.6690904  2.109371  3.1644015  1.2302672
4 -0.4042902 -0.1844615  0.779370  1.2302672  0.5479314
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
  row Sepal_Length Sepal_Width Petal_Length Petal_Width Species prod
1   0          5.1         3.5          1.4         0.2  setosa 0.28
2   1          4.9         3.0          1.4         0.2  setosa 0.28
3   2          4.7         3.2          1.3         0.2  setosa 0.26
\end{Soutput}
\end{Schunk}
...
> redimension(y, dim=c("class", "Species"), FUN=count, grand=TRUE) []
\end{Sinput}
\begin{Soutput}
...
\end{Sinput}
\begin{Soutput}
  n Sepal_Length Sepal_Width Petal_Length Petal_Width Species
1 0          4.9         3.1          1.5         0.1  setosa
2 1          4.8         3.0          1.4         0.1  setosa
3 2          4.3         3.0          1.1         0.1  setosa
\end{Soutput}
\begin{Sinput}
...
1   0          5.1         3.5          1.4         0.2  setosa             0
2   1          4.9         3.0          1.4         0.2  setosa             0
3   2          4.7         3.2          1.3         0.2  setosa             0
4   3          4.6         3.1          1.5         0.2  setosa             0
5   4          5.0         3.6          1.4         0.2  setosa             0
6   5          5.4         3.9          1.7         0.4  setosa             0
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] "R_arraye555779415e1101257184071"
\end{Soutput}
\begin{Sinput}
> C@schema
\end{Sinput}
...
asin                    as.scidb                atan
attribute_rename        bernoulli               between
bind                    build                   c
...
log                     max                     mean
median                  merge                   min
model_scidb             na.locf                 names
names<-                 ncol                    nrow
Ops                     order                   peek
persist                 phyper                  predict
print                   project                 qhyper
quantile                rank                    rbind
redimension             regrid                  remove_old_versions
rename                  repart                  replaceNA
reshape                 rownames                row.names
row.names<-             rownames<-              schema
scidb                   scidb_attributes        scidbconnect
scidb_coordinate_bounds scidb_coordinate_chunks scidb_coordinate_end
scidb_coordinate_overla scidb_coordinate_start  scidbdf
scidbdisconnect         scidbeval               scidb_fisher.test
