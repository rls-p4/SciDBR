...
\end{Sinput}
\begin{Soutput}
SciDB array name:  R_array2a744958edbd1...
...
\begin{Soutput}
           [,1]       [,2]       [,3]       [,4]      [,5]
[1,]  8.4151708  0.1499719 -2.8462983 -0.2295290 -3.253944
[2,]  0.1499719  6.7479528 -0.3039991 -0.6215236 -4.002421
[3,] -2.8462983 -0.3039991  2.4557626  0.6185673  2.741907
[4,] -0.2295290 -0.6215236  0.6185673  0.8387504  1.786353
[5,] -3.2539438 -4.0024207  2.7419065  1.7863531  6.231967
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] "redimension(redimension(between(transpose(test),3,null,3,null), <val:double>[j=3:3,4,0,i=0:4,5,0]), <val:double>[i=0:4,5,0])"
\end{Soutput}
\begin{Sinput}
> B@schema
\end{Sinput}
\begin{Soutput}
[1] "array<val:double> [i=0:4,5,0]"
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
[1] "R_array2a74f85fd1a1101055313670"
\end{Soutput}
\begin{Sinput}
> C@schema
\end{Sinput}
...
dimnames          dimnames<-        glm.fit           head
image             index_lookup      iquery            is.scidb
is.scidbdf        lag               length            log
max               mean              merge             min
names             names<-           ncol              nrow
print             project           redimension       regrid
rename            repart            reshape           rownames
rownames<-        scidb             scidbconnect      scidbdf
scidbeval         scidblist         scidbls           scidbremove
scidbrm           sd                show              sin
slice             sort              str               subset
